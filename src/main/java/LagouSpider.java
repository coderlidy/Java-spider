...
public class LagouSpider {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            WebElement cityAuthorElement = driver.findElement(By.xpath("//div[contains(text(),'给也不要')]"));
    ...
    private static void initialProperties() {
        switch (OSInfo.getOSType()) {
            ...
            case MACOSX:
                ...
                break;
            case WINDOWS:
                System.setProperty("webdriver.chrome.driver", LagouSpider.class.getClassLoader().getResource("chromedriver1.exe").getPath());
                break;
            default:
